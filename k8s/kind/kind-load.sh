...
docker pull jijonj/new-api-gateway:latest
docker pull jijonj/new-product-service:latest
docker pull jijonj/new-order-service:latest
docker pull jijonj/new-inventory-service:latest
docker pull jijonj/new-notification-service:latest
...
kind load docker-image -n microservices jijonj/new-api-gateway:latest
kind load docker-image -n microservices jijonj/new-product-service:latest
kind load docker-image -n microservices jijonj/new-order-service:latest
kind load docker-image -n microservices jijonj/new-inventory-service:latest
kind load docker-image -n microservices jijonj/new-notification-service:latest
